export function GoogleIcon() {
    return (
        ...
        >
            ...
            <path
                fill="#4CAF50"
                d="M24 44c5.166 0 9.86-1.977 13.409-5.192l-6.19-5.238C29.211 35.091 26.715 36 24 36c-5.176 0-9.629-3.329-11.287-7.946l-6.522 5.025C9.435 39.556 16.227 44 24 44z"
            />
            <path
                fill="#1976D2"
                d="M43.611 20.083H42V20H24v8h11.303c-1.058 3.118-3.057 5.569-5.684 7.238l.003-.002 6.19 5.238C35.373 40.785 44 34 44 24c0-1.341-.138-2.65-.389-3.917z"
            />
        </svg>
    );
}