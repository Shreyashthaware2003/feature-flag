    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-semibold tracking-tight text-black">Architecture Blueprint</h1>
        ...
        <section className="space-y-4">
          <div>
            <h2 className="text-xl font-semibold text-black">High-Level Design</h2>
        ...
        <section className="mt-10 space-y-4">
          <div>
            <h2 className="text-xl font-semibold text-black">Low-Level Design</h2>
            <p className="mt-1 text-sm text-gray-600">
        ...
        <section className="mt-8 rounded-2xl border border-gray-200 bg-gradient-to-b from-gray-50 to-white p-5">
          <h3 className="text-sm font-semibold text-black">Current API Contract</h3>
          <pre className="mt-3 overflow-x-auto rounded-lg border bg-white p-4 text-xs text-gray-800">
